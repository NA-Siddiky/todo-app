...
function OneWay(): React.JSX.Element {
  ...
  const fetchData = async (query: any) => {
    ...
    const fakeData = ['Item 1', 'Item 2', 'Item 3', 'Item 4', 'Item 5'];
    return fakeData;
  };
  ...
  return (
    <>
      <LoadingModal
        loaderImage={require('../../../../../assets/icons/loading.png')}
        visible={isLoading}
      />
              ...
              <CustomTextInput
                ...
                value={
                  (passengerCounts.adults > 0
                    ? `${passengerCounts.adults} Adults ,`
                    : '') +
                  (passengerCounts.children > 0
                    ? ` ${passengerCounts.children} Children ,`
                    : '') +
                  (passengerCounts.infants > 0
                    ? ` ${passengerCounts.infants} Infants ,`
                    : '') +
                ...
                <View style={styles.passengerCountSection}>
                  <View style={styles.passengerCountSectionSingle}>
                    ...
                    <View style={styles.passengerCountButtons}>
                      <TouchableOpacity
                        ...
                        onPress={() => decrementPassengerCount('adults')}>
                      ...
                      <TouchableOpacity
                        style={styles.roundButton}
                        onPress={() => incrementPassengerCount('adults')}>
                        <Text style={styles.roundButtonText}>+</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  ...
                  <View style={styles.passengerCountSectionSingle}>
                    ...
                    <View style={styles.passengerCountButtons}>
                      <TouchableOpacity
                        style={styles.roundButton}
                        onPress={() => decrementPassengerCount('children')}>
                        <Text style={styles.roundButtonText}>-</Text>
                      </TouchableOpacity>
                      <Text style={styles.passengerCountText}>
                      ...
                      <TouchableOpacity
                        style={styles.roundButton}
                        onPress={() => incrementPassengerCount('children')}>
                        <Text style={styles.roundButtonText}>+</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  ...
                  <View style={styles.passengerCountSectionSingle}>
                    ...
                    <View style={styles.passengerCountButtons}>
                      <TouchableOpacity
                        style={styles.roundButton}
                        onPress={() => decrementPassengerCount('infants')}>
                        <Text style={styles.roundButtonText}>-</Text>
                      </TouchableOpacity>
                      <Text style={styles.passengerCountText}>
                      ...
                      <TouchableOpacity
                        style={styles.roundButton}
                        onPress={() => incrementPassengerCount('infants')}>
                        <Text style={styles.roundButtonText}>+</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                ...
                <View style={styles.classSelectionSection}>
                  ...
                  <View>
                    <RadioButton
                      ...
                      selected={
                        selectedClass === 'premiumEconomy' ? true : false
                      }
